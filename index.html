...
<body>
  <div class="wrapper">
        ...
        <div class="article__roadmap">
          <div class="article__roadmap__container">
            ...
            <div class="article__roadmap__description">
              <div class="article__roadmap__description-items"><img src="source/1stPage/achieved.svg" alt="achieved">Website Creation</div>
              ...
              <div class="article__roadmap__description-items"><img src="source/1stPage/achieved.svg" alt="achieved">Creating an ERC-20 Token</div>
              <svg width="8" height="16" viewBox="0 0 8 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M5 12.01L5 -7.62939e-06L3 -7.62939e-06L3 12.01L4.76837e-07 12.01L4 16L8 12.01L5 12.01V12.01Z" fill="black"/>
              </svg>
              <div class="article__roadmap__description-items"><img src="source/1stPage/achieved.svg" alt="achieved">Creation STAGE collection cards and vouchers ERC-1155</div>
              <svg width="8" height="16" viewBox="0 0 8 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M5 12.01L5 -7.62939e-06L3 -7.62939e-06L3 12.01L4.76837e-07 12.01L4 16L8 12.01L5 12.01V12.01Z" fill="black"/>
              </svg>
              <div class="article__roadmap__description-items"><img src="source/1stPage/achieved.svg" alt="achieved">Airdrop FNT token to STAGE holders</div>
              <svg width="8" height="16" viewBox="0 0 8 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M5 12.01L5 -7.62939e-06L3 -7.62939e-06L3 12.01L4.76837e-07 12.01L4 16L8 12.01L5 12.01V12.01Z" fill="black"/>
              </svg>
              <div class="article__roadmap__description-items"><img src="source/1stPage/achieved.svg" alt="achieved">Launching a token swap system for a voucher</div>
              <svg width="8" height="16" viewBox="0 0 8 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M5 12.01L5 -7.62939e-06L3 -7.62939e-06L3 12.01L4.76837e-07 12.01L4 16L8 12.01L5 12.01V12.01Z" fill="black"/>
              </svg>
              <div class="article__roadmap__description-items"><img src="source/1stPage/achieved.svg" alt="achieved">Launching the Proof of Hold Reward System</div>
              <svg width="8" height="16" viewBox="0 0 8 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M5 12.01L5 -7.62939e-06L3 -7.62939e-06L3 12.01L4.76837e-07 12.01L4 16L8 12.01L5 12.01V12.01Z" fill="black"/>
              </svg>
    ...
    <a class="anchor" id="whitepaper"></a>
    <div class="white__paper__container">
      <button class="open__modal">whitepaper</button>
        <div class="modal">
          <div class="modal__content">
            <h4 class="modal__content__title">Choose your language:</h4>
            <a class="modal__content__link" href="https://falconofficial.com/whitepaper/WP-eng.pdf"><img src="source/1stPage/eng.svg" alt="">english</a>
            <a class="modal__content__link" href="https://falconofficial.com/whitepaper/WP-rus.pdf"><img src="source/1stPage/rus.svg" alt="">russian</a>
            <button class="modal__close"><img src="source/1stPage/x2.ico" alt=""></button>
          </div>
        </div>
    </div>
    <div class="swap__popup" id="popup">
      <div class="swap__popup__body">
        <div class="swap__popup__container">
          <a href="#" class="popup__exit">
            X
          </a>
          <div class="swap__popup-title">
          <h3>privet</h3>
          </div>
          <div class="swap__popup__description">
      ...
      <div class="team__members__list">
        <div class="team__members-list-admins">
          ...
          <div class="team-links">
            <a href="https://twitter.com/lavrus_crypto"><img class="team-links-twitter" src="source/1stPage/twitterfoot.svg" alt="twitter.logo">Dmitriy aka Lavrus</a>
            <a href="https://twitter.com/Falcon_Pr0ject"><img class="team-links-twitter" src="source/1stPage/twitterfoot.svg" alt="twitter.logo">Ivan</a>
            <a href="https://twitter.com/deadlinelogo"><img class="team-links-twitter" src="source/1stPage/twitterfoot.svg" alt="twitter.logo">Deadlinelogo</a>
            <a href="https://twitter.com/agud_falcon"><img class="team-links-twitter" src="source/1stPage/twitterfoot.svg" alt="twitter.logo">Alex Good</a>
          </div>
        </div>
        <div class="team__members-list-helpers">
          ...
          <div class="team-links">
            <a href="https://twitter.com/vi_taly"><img class="team-links-twitter" src="source/1stPage/twitterfoot.svg" alt="twitter.logo">Vitaly</a>
            <a href="https://twitter.com/shinobi_win"><img class="team-links-twitter" src="source/1stPage/twitterfoot.svg" alt="twitter.logo">Shinobi</a>
            <a href="https://twitter.com/1mkoma"><img class="team-links-twitter" src="source/1stPage/twitterfoot.svg" alt="twitter.logo">M K</a>
            <a href="https://twitter.com/Falcon_SBS"><img class="team-links-twitter" src="source/1stPage/twitterfoot.svg" alt="twitter.logo">Burton</a>
            <a href="https://twitter.com/Abubakr101?s=09"><img class="team-links-twitter" src="source/1stPage/twitterfoot.svg" alt="twitter.logo">Abu-Bakr</a>
          </div>
        </div>
      </div>
    </div>
